...
function Install-Scoop {
    ...
    if ($downloadZipsRequired) {
        ...
        $scoopMainZipfile = "$SCOOP_MAIN_BUCKET_DIR\scoop-official.zip"
        ...
        Copy-Item "$scoopMainUnzipTempDir\scoopbucket-*\*" $SCOOP_MAIN_BUCKET_DIR -Recurse -Force
...
$SCOOP_MAIN_BUCKET_DIR = "$SCOOP_DIR\buckets\official"
...
$SCOOP_PACKAGE_REPO = 'https://cfproxy.1122330.xyz/https://github.com/cmontage/Scoop/archive/main.zip'
$SCOOP_MAIN_BUCKET_REPO = 'https://cfproxy.1122330.xyz/https://github.com/cmontage/scoopbucket/archive/main.zip'

$SCOOP_PACKAGE_GIT_REPO = 'https://gitee.com/cmontage/scoop.git'
$SCOOP_MAIN_BUCKET_GIT_REPO = 'https://gitee.com/cmontage/scoopbucket.git'
